...
class Peinture
{
    ...
    #[ORM\Column(type: 'string', length: 255)]
    private $filePeinturePath;

    #[ORM\ManyToOne(targetEntity: Painters::class, inversedBy: 'peintures')]
    ...
    public function getFilePeinturePath(): ?string
    {
        return $this->filePeinturePath;
    }

    public function setFilePeinturePath(string $filePeinturePath): self
    {
        $this->filePeinturePath = $filePeinturePath;
